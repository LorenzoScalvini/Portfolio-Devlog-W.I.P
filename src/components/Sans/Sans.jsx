...
import styles from "./Sans.module.css";

const FLAME_SIZE = 25;
const HEART_SIZE = 10;
const BOX_SIZE = 300;
const MID_ATTACK_WIDTH = 80;
...
const Sans = () => {
  ...
  useEffect(() => {
    ...
    const initialDelay = setTimeout(() => {
      activateMidAttack();
      midAttackIntervalRef.current = setInterval(activateMidAttack, 5000);
    }, 5000);
  ...
  return (
    <div className={styles.container}>
      <audio ref={ostRef} src="sans.mp3" />
      <audio ref={deathRef} src="death-sans.mp3" />
      <audio ref={dangerRef} src="danger.mp3" />
      <audio ref={attackRef} src="sans-attack.mp3" />
      ...
      {(gameState === "menu" || gameState === "gameover") && !showVideo && (
        <div className={gameState === "menu" ? styles.menu : styles.retryMenu}>
          {gameState === "gameover" && <div className={styles.retryText}>Unlucky XDDDDD</div>}

          <img src="sans.gif" alt="Start Image" className={styles.startImage} />
      ...
      {(gameState === "fight" || gameState === "countdown") && !showVideo && (
        <div className={styles.gameWrapper}>
          <img 
            src={showAngryAsgore ? "sans.png" : "sans-angry.gif"} 
            alt="Asgore" 
          ...
          <img 
            src={"gaster.png"} 
            alt="gaster" 
            className={styles.gasterLeft} 
          />
                    <img 
            src={"gaster.png"} 
            alt="gaster" 
            className={styles.gasterRight} 
          />
